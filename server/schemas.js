...
module.exports = {
    ident_json, ident_schema,
    authors_json, authors_schema,
    skip_json, skip_schema,
    condition_json, condition_schema,
    optional_json, optional_schema,
    additional_json, additional_schema,
    dsig_details_json, dsig_details_schema,
    release_note_json, release_note_schema,
    defect_details_json, defect_details_schema,
    field_notice_details_json, field_notice_details_schema,
    ic_details_json, ic_details_schema,
    dsig_json, dsig_schema,
    cdets_json, cdets_schema
};
